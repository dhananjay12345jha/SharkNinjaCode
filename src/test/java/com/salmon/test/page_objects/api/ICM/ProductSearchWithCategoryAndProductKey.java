...
public class ProductSearchWithCategoryAndProductKey
{
    ...
    public boolean hitRequestWithCategoryAndProductKey(String categoryKey,String productKey)
    {
        boolean flag=false;
        ...
        try
        {
            ...
            log.info("Going to hit the URL-->>"+baseuri+"/-/categories/"+categoryKey+"/products/"+productKey);

            response = httpRequest.request(Method.GET, "/-/categories/"+categoryKey+"/products/"+productKey);
