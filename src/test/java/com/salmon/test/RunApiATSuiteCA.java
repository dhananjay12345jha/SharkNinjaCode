...
@CucumberOptions(features = "src/test/resources/features/api", tags = "@ApiTest_CA", monochrome = true, plugin = {
...
public class RunApiATSuiteCA extends AbstractTestNGCucumberTests {
