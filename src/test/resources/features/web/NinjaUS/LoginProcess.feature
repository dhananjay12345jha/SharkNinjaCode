...
@regNinjaUS
@regNinjaUSSuit2
Feature: Login: Validate login using valid and invalid credentials
  ...
  Scenario Outline: Validate login using invalid credentials
    ...
    Examples:
      ...
      | valid   | valid    | xyz@yopmail.com                  | abc@1234     | Your E-mail/Password combination is incorrect. Please try again. | Some Error message in FR                                                      |
