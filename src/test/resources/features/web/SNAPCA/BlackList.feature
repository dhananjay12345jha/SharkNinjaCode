Feature: Validate Blacklist Order creation for Customer in SNAP CA
  ...
  Scenario: Validate Blacklist Order creation for New Customer for Shark/Ninja CA
...
#    Then i should see "blacklist.order.id" in Order Number section
    ...
    Scenario: Validate Blacklist Order creation for Existing Customer for Shark/Ninja CA
