...
#    And click on accept cookies if visible
  ...
  #currently skipped as discussed in biweekly call on 14-Dec
#  @ValidateBrandUniformity
#  Scenario: Verify user is not allowed to Proceed with Order process on the Non Brand channel on Storefront
#    When I click on add to cart button
#    And I click on cart icon
#    Then I should be on cart page where text shown is "Cart" or "Panier"
#    And language selected should be equal to "select.language.to.test"
