Feature: Validate Blacklist Order creation for Customer in SNAP UK
  ...
  Scenario: Validate Blacklist Order creation for New Customer for Shark/Ninja UK
...
#    Then i should see "blacklist.order.id" in Order Number section
  ...
  Scenario: Validate Blacklist Order creation for Existing Customer for Shark/Ninja UK
